...
class Node:
    ...
    def find_block_generation_probability(self):
        ...
        if rate == 0:
            ...
            self.block_generation_probability = expon.cdf(10,scale = 10/rate)
    ...
    def _connecting(self, node, connection):
        ...
        During the simulation we only simulate it once.
        We consider that a node communicate with his peer using an open connection
