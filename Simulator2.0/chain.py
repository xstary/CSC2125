...
class Chain:
    ...
    def add_block(self, block):
        ...
        if pkey in self.db:
            ...
            #     Receiving block #{block.height} ({block.hash}) \
            #     not on head ({self._head_hash}), \
            ...
            # the block should be the new head, replace the head
            if block.height > self.head.height:
                ...
                # # Find common ancestor and update main chain??
                # while b.height >= 0:
